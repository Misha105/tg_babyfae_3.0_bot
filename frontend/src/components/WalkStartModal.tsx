...
import { X, Clock, Footprints } from 'lucide-react';
...
export const WalkStartModal: React.FC<WalkStartModalProps> = ({ onClose, onConfirm }) => {
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Clock className="h-5 w-5 text-slate-500 group-focus-within:text-emerald-400 transition-colors" />
                </div>
                <input
                  type="datetime-local"
                  value={startTime}
                  ...
                  className="block w-full pl-10 pr-3 py-3 bg-slate-950 border border-slate-700 rounded-xl focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 text-white placeholder-slate-600 transition-all outline-none scheme-dark"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button 
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-emerald-600 text-white font-bold hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-500/25"
              >
                {t('dashboard.start_walk')}
              </button>
            </div>
